...
def parse_cli_arguments():
    ...
    parser.add_argument("--train_folder", type=str, required=True, help="Path to the input train folder.")
    parser.add_argument("--test_folder", type=str, required=True, help="Path to the input test folder.")
...
def main():
    ...
    mean, std = get_mean_std(train_folder, test_folder, modality = args.modality)
    ...
    # Define model name
    model_name = "conv_next_model" #resnet18 "DroughtCNN" 
