"""
hacked from https://raw.githubusercontent.com/pytorch/vision/main/torchvision/models/resnet.py

to create a resnet 18 w/ a different number of input channels: 

model = resnet18(input_channels=44)
"""
